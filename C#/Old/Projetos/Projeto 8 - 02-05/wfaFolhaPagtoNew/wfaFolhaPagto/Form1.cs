...
namespace wfaFolhaPagto
{
    public partial class Form1 : Form
    {
        ...
        void Calcular()
        {
           double sb, inss, salIr, ir, sl;
            try
            {
                           
                sb = funcionario1.horasTrabalhadas * funcionario1.valorHora;

                inss = funcionario1.calculaINSS(sb);

                salIr = sb - inss - (funcionario1.numDependetes * 144.20);
                ir = funcionario1.calculaIR(salIr);
        ...
        void Atribuir()
        {
            try
            {
                funcionario1.nome = txtNome.Text;
                funcionario1.horasTrabalhadas = float.Parse(txtHT.Text);
                funcionario1.valorHora = float.Parse(txtVH.Text);
                funcionario1.numDependetes = int.Parse(txtDep.Text);
        ...
        private void btnLimpar_Click(object sender, EventArgs e)
        {
            ...
            funcionario1.nome = "";
            funcionario1.valorHora = 0;
            funcionario1.horasTrabalhadas = 0;
            funcionario1.numDependetes = 0;
        ...
        {
            DialogResult btnFimResult = MessageBox.Show("Deseja encerrar?","Atenção",MessageBoxButtons.YesNo,MessageBoxIcon.Question,MessageBoxDefaultButton.Button2);
