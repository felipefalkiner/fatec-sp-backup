	...
	public static void main(String args[]){
		...
		for(i = 0; i<tam; i++){
			...
			if(tipo.equalsIgnoreCase("a")){
				...
				frota[i] = new Carro(modelo, placa, anoFabr, valor, anoModelo, numPortas);
			}else if(tipo.equalsIgnoreCase("c")){
				System.out.println("Capacidade (toneladas): ");
				capacidade = nInput.nextDouble();
				System.out.println("Num eixos: ");
				numEixos = nInput.nextInt();
				frota[i] = new Caminhao(modelo, placa, anoFabr, valor, capacidade, numEixos);
			}else{
