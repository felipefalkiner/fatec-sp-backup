...
return true;
	...
	/*
$conexao = mysql_connect("127.0.0.1","root","c3x2z1");
if (!$conexao)
...
$strCount = "SELECT COUNT(*) AS 'num_registros' FROM historico WHERE cpfpaciente=$cpf"; 
...
$strQuery = "SELECT * FROM historico WHERE cpfpaciente=$cpf ORDER BY idhistorico DESC";      
...
?>
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-top:10px;">
                        <a class="btn btn-block btn-danger" href="dashm.php">Voltar Menu Inicial</a>
                    </div>
					</form>
                </div>
            </div>
